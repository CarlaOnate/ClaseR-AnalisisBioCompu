---
title: "Ejercicios C4"
author: "Abraham Chalita, Marco Pérez, Carla Onate"
date: "8/4/2021"
output:
...
```{r}
longitud <- readline(prompt = "Introduzca tamaño de secuencia: ")
...
cat("Tamaño de la secuencia: ", tamañoDNA(DNA))
```
...
cat("DNA original: ", DNA)
cat("DNA transcrito: ", transcribe(DNA))
...
cat("DNA a proteína: ", to_protein(RNA))
...
cat("Hebra directa: ", string)
cat("Hebra inversa: ", inversa(DNA))
...
cat("Hebra complementaria: ", complement(DNA))
...
cat("Hebra complementaria inversa: ", compinver(DNA))
```
