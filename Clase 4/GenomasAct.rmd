...
proteins <- list(UU=c(U='phe', C='phe', A='leu', G='leu'), CU='Leu', AU=c(A='ile', C='ile', U='ile', G='met'), GU='Val', UC='Ser', CU='Pro', AC='Thr', GC='Ala', UA=c(U='tyr', C='tyr'), CA=c(U='his', C='his', A='gin', G='gin'), AA=c(U='asn', C='asn', A='lys', G='lys'), GA=c(U='asp', C='asp', A='glu', G='glu'), UG=c(U='cys', C='cys', G='trp'), CG='Arg', AG=c(U='ser', C='ser', A='arg', G='arg'), GG='Gly')

translation <- function(RNA){
  #Add if for stop values
  ...
  for(el in RNA){
    ...
    proteinValType<-typeof(proteins[firstTwoLetter])

    if(proteinValType == "character"){
      print(proteins[firstTwoLetter][lastLetter])
      print(proteins[firstTwoLetter])
      #resProteins<-c(resProteins, proteins[firstTwoLetter])
    } else {
      print(proteins[firstTwoLetter][lastLetter])
      #resProteins<-c(resProteins, proteins[firstTwoLetter][lastLetter])
    }
  }
  return(resProteins)
}
